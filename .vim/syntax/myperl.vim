" Perl syntax file for vim
" Most of this is copied from the official vim perl syntax file
" Items starting with myperl were made by quietfanatic though.
...
HiLink perlIdentifier		NONE "Identifier
HiLink perlLabel		NONE "Label
HiLink perlStatement		NONE "Statement
HiLink perlConditional		NONE "Conditional
HiLink perlRepeat		NONE "Repeat
HiLink perlOperator		NONE "Operator
HiLink perlFunction		Keyword
HiLink perlSubName		Identifier "Function
HiLink perlSubPrototype		NONE "Type
HiLink perlSubAttributes	NONE "PreProc
HiLink perlSubAttributesCont	NONE "perlSubAttributes
...
HiLink perlPackageDecl		myperlIdentifier "perlType
HiLink perlStorageClass		perlType
HiLink perlPackageRef		perlType
HiLink perlStatementPackage	PreProc "perlStatement
...
HiLink perlDATA			perlString "perlComment
